...
{
	/** Variable h for radial distance to nearby particles. */
	public double h = 0.0575;
	...
	/** List of Objects for collision. */
	public ArrayList<CollisionObject>	O = new ArrayList<CollisionObject>();
	
	/** List of Constraints. */
	public ArrayList<Constraint>	C = new ArrayList<Constraint>();
	
	/** List of PostProcessing Modifiers.*/
	public ArrayList<PostModifier> M = new ArrayList<PostModifier>();
	...
	/** The Solver used by this particle system. */
	
	//public Solver solver = new VerletSolver(this);
	
	public Solver solver = new EulerSolver(this);
